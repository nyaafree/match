...
　
  ...
  <li class="p-hamburger__list js-nav-close"><a href="/#category" class="p-hamburger__link">案件種別表示</a></li>
  <li class="p-hamburger__list js-nav-close"><a href="/#paging" class="p-hamburger__link">ページネーション</a></li>
</ul>
</nav>
