<nav class="p-hamburger js-toggle-sp-menu-target">
        <form action="search" method="GET" class="hamburger-search">
...
　
  ...
  @if (Auth::check())
    ...
    <li class="p-hamburger__list js-nav-close"><a href="mypage#direct" class="p-hamburger__link">投稿ダイレクトメッセージ一覧</a></li>
  @else
  ...
  <li class="p-hamburger__list js-nav-close"><a href="/match#category" class="p-hamburger__link">案件種別表示</a></li>
  <li class="p-hamburger__list js-nav-close"><a href="/match#paging" class="p-hamburger__link">ページネーション</a></li>
</ul>
</nav>
