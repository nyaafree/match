            ...
            <div class="c-post__formArea">
                <form action="/items" method="POST" class="c-post__form">
                    ...
                    <div class="c-post__inputGroup">
                        ...
                        <input type="text" class="c-post__input" name="title" id="title" value="{{ $item->title }}">
                    </div>
                    <div class="c-post__inputGroup">
                        <label for="category_id" class="c-post__labelTitle">案件カテゴリ</label>
                        <select name="category_id" id="category_id" class="c-post__select">
                            <option class="c-post__option" value="0">カテゴリを選択してください</option>
                    ...
                    <div class="c-post__inputGroup">
                        ...
                        <div class="c-post__priceWrapper">
                           ...
                           <div>
                               <input type="text" name="lowPrice" class="c-post__price" value="{{ $item->lowPrice }}"><span>000</span>
                           </div>
                           <span class="c-post__center">〜</span>
                           <div>
                               <input type="text" name="highPrice" class="c-post__price" value="{{ $item->highPrice }}"><span>000</span>
                           </div>
                        </div>
                    </div>
